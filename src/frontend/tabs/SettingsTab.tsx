...
import { Loader2, Coffee, Cpu, FolderOpen } from "lucide-react"
...
export function SettingsTab({ settings, launcherDirectory, onSettingsChange }: SettingsTabProps) {
...
const getMemoryRecommendation = (mb: number) => {
    if (!systemInfo) {
      // Fallback recommendations while loading
