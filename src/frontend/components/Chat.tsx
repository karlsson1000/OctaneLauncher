        ...
        >
          ...
          <div className="flex items-center justify-between px-4 py-3 bg-[#2b2f38]">
            <div className="flex items-center gap-3">
              <img
                src={`https://avatar.mcindex.net/avatar/${friendUsername}/32`}
                alt={friendUsername}
                    ...
                    <div className={`flex gap-2 items-start ${isOwn ? 'justify-end' : 'justify-start'}`}>
                      {!isOwn && (
                        <div className="w-6 flex-shrink-0">
                          {!isGrouped && (
                            <img
                              src={`https://avatar.mcindex.net/avatar/${friendUuid}/32`}
                              alt={friendUsername}
                      ...
                      {isOwn && (
                        <div className="w-6 flex-shrink-0">
                          {!isGrouped && (
                            <img
                              src={`https://avatar.mcindex.net/avatar/${currentUserUuid}/32`}
                              alt="You"
                              className="w-6 h-6 rounded"
                            />
                          )}
